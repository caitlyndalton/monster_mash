...
Campaign.create!(user_id: 1, name: "Secrets of Fishin's Good", description: "The small coastal town of Fishin's Good - definitely nothing weird going on in that abandoned Council Building.")
Campaign.create!(user_id: 1, name: "Journey to the Underdark", description: "Ever wanted to take a quick road trip to the Underdark? Yeah, no one really does. Shit's dangerous. Lolth-Sworn Drow, fiends, worgs - oh my!")
